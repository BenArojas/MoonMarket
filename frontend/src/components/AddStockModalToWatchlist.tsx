...
import { ToggleWatchlistResponse } from '@/pages/Watchlist';
...
interface AddStockModalProps {
  ...
  setNewStockTicker: (ticker: string) => void;
  handleAddToWatchlist: () => void;
  toggleWatchlistMutation: ReturnType<
    typeof useMutation<ToggleWatchlistResponse, Error, string>
  >;
}
